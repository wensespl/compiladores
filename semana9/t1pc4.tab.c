...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_S = 18,                         /* S  */
  YYSYMBOL_listaInstr = 19,                /* listaInstr  */
  YYSYMBOL_instr = 20,                     /* instr  */
  YYSYMBOL_21_1 = 21,                      /* @1  */
  YYSYMBOL_expr = 22,                      /* expr  */
  YYSYMBOL_term = 23,                      /* term  */
  YYSYMBOL_term2 = 24                      /* term2  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "PROGRAMA", "ID",
  "INICIO", "FIN", "NUM", "VARIABLE", "';'", "'.'", "':'", "'='", "'+'",
  "'-'", "'*'", "'/'", "$accept", "S", "listaInstr", "instr", "@1", "expr",
  "term", "term2", YY_NULLPTR
};
...
{
       6,     9,    10,     5,   -16,    11,    13,   -16,    12,    13,
       4,    14,   -16,     7,   -16,    -1,   -16,   -16,    -9,   -14,
     -16,   -16,    -1,    -1,    -1,    -1,   -14,   -14,   -16,   -16
};
...
{
       0,     0,     0,     0,     1,     0,     4,     5,     0,     4,
       0,     0,     3,     0,     2,     0,    14,    13,     0,     9,
      12,     6,     0,     0,     0,     0,     7,     8,    10,    11
};
...
{
      21,    24,    25,    16,    22,    23,    17,    26,    27,     1,
       4,    28,    29,     3,     5,    13,     6,     7,    11,    15,
       0,     0,     0,     0,    14,    12
};

static const yytype_int8 yycheck[] =
{
       9,    15,    16,     4,    13,    14,     7,    22,    23,     3,
       0,    24,    25,     4,     9,    11,     5,     4,     6,    12,
      -1,    -1,    -1,    -1,    10,     9
};
...
{
       0,     3,    18,     4,     0,     9,     5,     4,    19,    20,
      21,     6,    19,    11,    10,    12,     4,     7,    22,    23,
      24,     9,    13,    14,    15,    16,    23,    23,    24,    24
};

/* YYR1[RULE-NUM] -- Symbol kind of the left-hand side of rule RULE-NUM.  */
static const yytype_int8 yyr1[] =
{
       0,    17,    18,    19,    19,    21,    20,    22,    22,    22,
      23,    23,    23,    24,    24
};
...
#line 1147 "t1pc4.tab.c"
    break;

  case 13: /* term2: NUM  */
#line 35 "t1pc4.y"
           {yyval = localizaSimb(lexema,NUM);}
#line 1153 "t1pc4.tab.c"
    break;

  case 14: /* term2: ID  */
#line 36 "t1pc4.y"
                      {yyval = localizaSimb(lexema,ID);}
#line 1159 "t1pc4.tab.c"
    break;


#line 1163 "t1pc4.tab.c"
